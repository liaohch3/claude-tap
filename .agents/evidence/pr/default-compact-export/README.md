...
- Compact export: `/tmp/claude-tap-compact-check/trace.ctap.json`, 68 MB.
- Full JSON comparison: `/tmp/claude-tap-compact-check/trace.full.json`, 93 MB.
- HTML export: `/tmp/claude-tap-compact-check/trace.html`, contains `EMBEDDED_TRACE_COMPACT_DATA` and no full `const EMBEDDED_TRACE_DATA =` injection.
