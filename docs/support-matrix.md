...
| Claude Code | OrcaRouter gateway (`ANTHROPIC_BASE_URL=https://api.orcarouter.ai`) | `https://api.orcarouter.ai` | none | HTTP/SSE | Unit-tested; live `/v1/messages` and `/v1/chat/completions` verified |
