...
def test_codexapp_defaults_to_forward_mode() -> None:
...
def test_parse_args_codexapp_defaults_to_forward_proxy_mode() -> None:
...
def test_parse_args_rejects_transcript_proxy_mode() -> None:
    with pytest.raises(SystemExit):
        parse_args(["--tap-client", "codexapp", "--tap-proxy-mode", "transcript"])


def test_parse_args_codexapp_accepts_trust_ca_in_default_forward_mode() -> None:
    args = parse_args(["--tap-client", "codexapp", "--tap-trust-ca"])
