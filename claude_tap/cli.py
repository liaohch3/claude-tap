...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    tap_parser = argparse.ArgumentParser(
        ...
        epilog=(
            ...
            "  # Note: `hermes gateway` is a messaging-platform bot gateway, not an LLM proxy.\n"
            "  # It only makes LLM calls when platform messages arrive; use TUI mode for local tracing.\n"
            "\n"
