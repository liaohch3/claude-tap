...
- 🧩 **Use one workflow across clients**: trace Claude Code, Codex CLI, Gemini CLI, Kimi CLI, OpenCode, Pi, Hermes Agent, Cursor CLI, Qoder CLI, and DeepSeek TUI.
...
| [DeepSeek TUI](https://deepseek-tui.com) | DeepSeek TUI sessions through reverse proxy mode |
